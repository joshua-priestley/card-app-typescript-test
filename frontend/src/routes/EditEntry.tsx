...
export default function EditEntry(){
    ...
    return(
        <section className="flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 p-8 rounded-md dark:bg-gray-700">
            ...
            <button onClick={(e) => {handleSend(e)}} className="bg-blue-400 hover:bg-blue-600 font-semibold text-white p-3 rounded-md dark:bg-gray-800 dark:hover:bg-gray-900">Update</button>
        </section>
    )
}